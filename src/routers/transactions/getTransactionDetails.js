...
const getTransactionDetails = router.get(
  ...
  async (req, res, next) => {
    ...
    try {
      ...
      const sqlDetails = `select invoice, transaction_id, product_id, prescriptionPhoto, productName, productPrice, productPhoto, qty, variant, d.createdAt, d.updatedAt, user_id, status, paymentPhoto, isByPrescription  from detailTransaction d 
